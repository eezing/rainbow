...
const color = (state, action) => {
    ...
    case INSERT:
        return Object.assign({}, state, { active: state.hex === action.color.hex ? true : false });
...
const colors = (state = [], action) => {
    ...
    case REMOVE:
        ...
        }).map((item, index) => index === nextActiveIndex ? Object.assign({}, item, { active: true }) : item);
